...
const AmenitiesCard = (props) => {
    ...
    return (
        <div className="w-full px-2">
            <div className="flex items-center h-16 w-full shadow-lg overflow-hidden rounded-lg py-3 px-6 mb-4 bg-gray-100 transition cursor-pointer hover:bg-gray-200">
